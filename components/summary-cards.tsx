    ...
    <div className="space-y-3">
      ...
      <Card className="relative">
        <CardContent className="flex flex-col gap-2 pt-5 pb-4">
          <div className="absolute right-3 bottom-3 flex h-5 w-5 items-center justify-center rounded-md bg-muted">
            <Wallet className="h-3 w-3 text-foreground" />
          </div>
          <p className="text-xs font-medium text-muted-foreground">Total Balance</p>
          <p className="text-xl font-bold tracking-tight">{formatAmount(totalBalance)}</p>
        </CardContent>
      </Card>
      ...
      <Card className="relative">
        <CardContent className="flex flex-col gap-2 pt-5 pb-4">
          ...
          <p className="text-xs font-medium text-muted-foreground">Income · {periodLabel(period)}</p>
          <p className="text-xl font-bold tracking-tight">{formatAmount(periodIncome)}</p>
        </CardContent>
      </Card>
      ...
      <Card className="relative">
        <CardContent className="flex flex-col gap-2 pt-5 pb-4">
          ...
          <p className="text-xs font-medium text-muted-foreground">Expenses · {periodLabel(period)}</p>
          <p className="text-xl font-bold tracking-tight">{formatAmount(periodExpenses)}</p>
        </CardContent>
      </Card>
      ...
      <Card className="relative">
        <CardContent className="flex flex-col gap-2 pt-5 pb-4">
          ...
          <p className="text-xl font-bold tracking-tight text-destructive dark:text-red-400">{formatAmount(totalDebt)}</p>
        </CardContent>
      </Card>
      ...
      <Card className="relative">
        <CardContent className="flex flex-col gap-2 pt-5 pb-4">
          ...
          <p className="text-xl font-bold tracking-tight text-green-600 dark:text-green-400">{formatAmount(totalReceivable)}</p>
        </CardContent>
      </Card>
      </div>
    </div>
